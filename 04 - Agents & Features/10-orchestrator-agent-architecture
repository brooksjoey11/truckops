...
<p>The Orchestrator is built on the same shared foundation as all other TruckOps agents. It uses:</p>

<ul>
  <li><strong>OpenClaw's agent framework</strong> as the runtime</li>
  <li><strong>LanceDB</strong> for semantic memory</li>
  <li><strong>Active Memory</strong> for automatic context retrieval</li>
  <li><strong>memory-wiki</strong> for provenance and auditing</li>
  <li><strong>openclaw-superpowers</strong> for skill writing (in propose‑mode initially)</li>
  <li><strong>SQLite</strong> for structured data access</li>
</ul>
...
<p><span style="color:#A5B4FC; font-weight:600;">Status:</span> Planned. The architecture is defined. Implementation depends on the foundation build and the availability of at least three specialist agents for the Orchestrator to coordinate.</p>

<p><span style="color:#A5B4FC; font-weight:600;">Priority:</span> High. The Orchestrator is the primary interface to the system and should be built as soon as the foundation and a minimum set of specialists are operational.</p>
